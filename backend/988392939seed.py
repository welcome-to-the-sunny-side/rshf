        ...
        for i in range(30):
            ...
            announcement_batch.append(
                Announcement(
                    ...
                    content="random random random random random random random"
                )
            )
    ...
    for i in range(5):  # Add 5 global announcements
        ...
        global_announcement_batch.append(
            Announcement(
                ...
                title=f"Global Announcement: random random random random",
                content="random random random random random"
            )
        )
